  ...
  return (
    <div className="w-full h-screen p-4 pb-32 bg-transparent font-mono text-slate-300 overflow-hidden relative flex flex-col items-center justify-start">
      ...
      <div className="w-full flex-1 max-w-[1600px] mt-40 relative grid grid-cols-12 gap-6 px-4 lg:px-10 pointer-events-auto h-full pb-10">
        ...
        {/* Left: Ticker Sidebar */}
        <div className="col-span-12 lg:col-span-4 space-y-3 flex flex-col justify-start">
          <HudPanel title="Live Ticker Sidebar // ASSETS">
            {commodities.map((item) => (
              <button
                key={item.id}
                onClick={() => setSelected(item.id)}
                className={`w-full p-4 mb-2 rounded-none border transition-all duration-300 text-left relative overflow-hidden group ${
                  selected === item.id 
            ...
            <div className="mt-4 p-4 bg-red-500/5 border border-red-500/20 rounded-none relative overflow-hidden group">
        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col h-full">
          <HudPanel title="FORENSIC MARKET SCAN // ALGO" className="h-[550px] flex flex-col">
            ...
            <div className="mt-6 flex justify-between items-center text-[9px] font-mono text-slate-500 border-t border-slate-800 pt-4 tracking-widest font-bold">
