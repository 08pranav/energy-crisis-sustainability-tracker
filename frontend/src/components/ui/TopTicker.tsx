...
const TopTicker = () => {
  ...
  return (
    ...
    <div className="fixed top-0 left-0 w-full z-[60] bg-black/80 backdrop-blur-md border-b border-white/10 py-1.5 overflow-hidden">

      <div className="flex whitespace-nowrap animate-marquee">

        {[...commodities, ...commodities].map((item, i) => (

          <div key={i} className="flex items-center gap-4 px-8 font-mono text-[10px] tracking-wider">
